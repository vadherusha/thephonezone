...
class Checkout(models.Model):
    ...
    firstname=models.CharField(max_length=12,default="" ,verbose_name="first name")
    lastname=models.CharField(max_length=15,default="",verbose_name="last name")
    email=models.CharField(max_length=45,default="",verbose_name="email")
    phone = models.PositiveIntegerField(default="",verbose_name="phone number")
    companyname=models.CharField(max_length=70, default="",verbose_name="company name")
    country=models.CharField(max_length=45, default="",verbose_name="country name")
    town=models.CharField(max_length=157, default="",verbose_name="town name")
    state=models.CharField(max_length=15, default="",verbose_name="state name")
